...
CREATE TABLE IF NOT EXISTS dbasakan.residences (
  ...
  syndic_user_id text UNIQUE,
  guard_user_id text UNIQUE,
...
-- Migrations for schema refactoring
-- Ensure columns exist even if table was created before this script updated
...
-- Remove residence_id from profiles if exists
